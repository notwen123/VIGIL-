...
Flagger is Argus's feature flagging system built on top of the [OpenFeature](https://openfeature.dev/) standard. It provides a unified interface for evaluating feature flags across the application, allowing features to be enabled, disabled, or configured dynamically without code changes.
...
```go
import (
    "github.com/Argus/argus/pkg/flagger"
    "github.com/Argus/argus/pkg/types/featuretypes"
)
