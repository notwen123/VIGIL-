...
> **This is the prior-work document.** It describes the VIGIL runtime
> governance platform: intent policy, cost forecasting, behavioural
> detectors, model routing and the audit ledger.
>
> The hackathon submission is **VIGIL MEMORY**, the cross-session trust layer
> built on top of it. Start at [README.md](../README.md) and
> [MEMORY.md](../MEMORY.md).
...
## Prior submission — Impact Forge, Summer 2026

The platform described in this document was built for Impact Forge's General
Innovation track. It is **prior work**, disclosed as such. VIGIL MEMORY — the
cross-session trust layer — is the new work, and is documented in
[MEMORY.md](../MEMORY.md).
...
Original VIGIL code (`pkg/query-service/vigil/`, `pkg/acp/`, `services/`) is
**MIT** — see [LICENSE.MIT](../LICENSE.MIT). The inherited SigNoz fork remains
**Apache-2.0** — see [LICENSE](../LICENSE). Both are OSI-approved.
