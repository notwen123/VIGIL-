...
import { SOCIAL_ICONS, WIGGLE_CONFIG } from '@/lib/landing-data';
    ...
    return (
        <div className="footer-inner">
            <div className="footer-top">
                ...
                {/* Office */}
                <div className="footer-column">
                    <span className="footer-badge">run it</span>
                    <address>
                        make vigil-run<br />
                        make demo
                    </address>
                ...
                <div className="footer-column">
                    ...
                    <a href="mailto:hello@vigil.dev" className="footer-email">hello@vigil.dev</a>
                    <a href="#" className="footer-whatsapp">report a vulnerability*</a>
                    <p className="footer-note">*see SECURITY.md — no third-party pentest has been performed.</p>
            ...
            <div className="footer-bottom">
                <div className="footer-big-text">
                    <span className="footer-wordmark">VIGIL</span>
                </div>
                        ...
                        <div className="credits-box">
                            <div className="credits-content">
                                <div className="credits-item credit-wiggle">
                                    <div className="overflow-wrapper"><span className="credits-label">built on</span></div>
                                    <div className="overflow-wrapper"><a href="#" className="credits-name" data-wiggle-target="true">Go + MCP</a></div>
                                </div>
                                <div className="credits-item credit-wiggle">
                                    <div className="overflow-wrapper"><span className="credits-label">traced with</span></div>
                                    <div className="overflow-wrapper"><a href="#" className="credits-name" data-wiggle-target="true">OpenTelemetry</a></div>
                                </div>
                            </div>
                        </div>
