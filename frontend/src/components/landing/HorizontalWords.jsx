        ...
        <section ref={sectionRef} className="horizontal-words-section content-section">
            <div className="horizontal-words__relative">
                <div className="horizontal-words__sticker-svg">
                    ...
                    <h2 className="display horizontal-words__h2" aria-label="Between the agent and the tool">
            ...
            <div className="horizontal-words__bottom-text">
                <div className="horizontal-words__bottom-text-l">
                    An agent does not break. It works exactly <em>as designed</em><br />
                    while doing something nobody sanctioned. Vigil is the layer<br />
                    that decides before the tool is ever reached.
                </div>
            </div>
        </section>
    );
