...
import { brands, colors } from '@/lib/landing-data';
...
export default function DoubleMarquee() {
    ...
    useEffect(() => {
        ...
        // The track contents are randomised and depend on viewport width, so
        // they cannot be computed during render: the server and the client
        // would shuffle differently and React would report a hydration
        // mismatch. An effect is the correct place, and this runs once on
        // mount rather than cascading.
        ...
        <>
            ...
            <div className="marquee-left">
                <div className="marquee-text-container">
                    <h2>governing agents<br />on <span className="text-with">day one:</span></h2>
                            ...
                            {trackItems.map((item, i) => (
                                <div key={i} className="marquee-item" data-brand={item.brand.name} style={{ backgroundColor: item.color }}>
                                    <div className="marquee-logo">
                                        ...
                                        <span className="marquee-wordmark">{item.brand.label}</span>
                                    </div>
                                </div>
                            ))}
                        </div>
