                ...
                */}
                ...
                <div className="home-header__title">
                    <h1 className="vimeo-hero__title" ref={titleRef} onClick={(e) => e.stopPropagation()}>
                        ...
                        <span className="vimeo-hero__word"><em>every </em></span>
                        <span className="vimeo-hero__word">call </span>

                        <div style={{ flexBasis: '100%', height: 0 }} />

                        <span className="vimeo-hero__word">before </span>
                        <span className="vimeo-hero__word">it </span>

                        {/* "runs" + star + oval underline */}
                        <span className="vimeo-hero__word is--relative">
