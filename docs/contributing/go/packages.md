...
All shared Go code in Argus lives under `pkg/`. Each package represents a distinct domain concept and exposes a clear public interface. This guide covers the conventions for creating, naming, and organising packages so the codebase stays consistent as it grows.
...
import (
    ...
    // 3. Internal
    "github.com/Argus/argus/pkg/errors"
    "github.com/Argus/argus/pkg/types"
)
```
