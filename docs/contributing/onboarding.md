...
This guide explains how to add new data sources to the Argus onboarding flow. The onboarding configuration controls the "New Source" / "Get Started" experience in Argus Cloud.
...
4. Validation:
   - Navigate to the [onboarding page](http://localhost:3301/get-started-with-argus-cloud) on your local machine
