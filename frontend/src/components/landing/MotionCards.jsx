        ...
        <section
            ...
            <div className="motion-card__cards-area">
                    ...
                    <div className="motion-card__card motion-card__card--1">
                        <div className="motion-card__card-image">
                            <img
                                ...
                                width={1000}
                                height={1000}
                                alt="Server racks in a dark data hall"
                    ...
                    <div className="motion-card__card motion-card__card--2">
                        <div className="motion-card__card-image">
                            <img
                                ...
                                width={1000}
                                height={1000}
                                alt="Networked nodes glowing across a dark globe"
                                className="cover-image"
                            />
                        </div>
                    </div>
                    ...
                    <div className="motion-card__card motion-card__card--3">
                        <div className="motion-card__card-image">
                            <img
                                ...
                                width={1000}
                                height={1000}
                                alt="Abstract machine-intelligence form"
                                className="cover-image"
                            />
                        </div>
                    </div>
                    ...
                    <div className="motion-card__card motion-card__card--4">
                        <div className="motion-card__card-image">
                            <img
                                ...
                                width={1000}
                                height={1000}
                                alt="Streams of code on a dark terminal"
                                className="cover-image"
                            />
                        </div>
                    </div>
                ...
                <div ref={containerRef} className="motion-card__floating-labels">
                    <div className="motion-card__floating-label motion-card__floating-label--pink">
                        <p className="motion-card__floating-text">the model never gets the last word</p>
                    </div>
                    <div className="motion-card__floating-label motion-card__floating-label--orange">
                        <p className="motion-card__floating-text">deterministic first, model second</p>
                    </div>
                    <div className="motion-card__floating-label motion-card__floating-label--red">
                        <p className="motion-card__floating-text">audit the allows, not just the blocks</p>
                    </div>
                </div>
            </div>
            ...
            <div className="motion-card__footer-text">
                <p className="motion-card__description">
                    Prompt rules can be argued out of. Allowlists are context-free.
                    Observability tells you afterwards, when the spend is already
                    spent. Vigil sits on the hot path and answers before the call
                    executes — in microseconds, and in a sentence you can read.
                </p>
            </div>
        </section>
    );
